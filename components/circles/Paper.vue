<template lang="">
  <div>
    <div class="absolute left-0 cursor-pointer">
      ...
      <div class="">
        <div
          class="absolute xl:-top-16 xl:-left-20 -top-7 -left-10 scale-95 bg-paperDark opacity-70 xl:h-48 xl:w-48 h-32 w-32 rounded-full"
        ></div>
        <div
          class="absolute xl:-top-20 xl:-left-20 -top-10 -left-10 bg-paperDarker xl:h-48 xl:w-48 h-32 w-32 rounded-full"
        ></div>
        <div
          class="absolute xl:-top-20 xl:-left-20 -top-10 -left-10 scale-75 bg-gray-200 xl:h-48 xl:w-48 h-32 w-32 rounded-full"
        ></div>
      </div>
      <!-- paper  -->
